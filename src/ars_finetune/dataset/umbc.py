...
class UmbcDataSet(BaseDataset):
    def __init__(self, root, list_path, set='new',
                 max_iters=None,
    ...
    def get_metadata(self, name):
        ...
        label_name = name.replace(".png", "_label_mask.png")
        label_file = self.root / self.set / 'LabelMasks' / label_name
